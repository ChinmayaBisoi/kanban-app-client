...
const Navbar = () => {
  ...
  return (
    <nav className="self-stretch sticky top-0 backdrop-saturate-200 backdrop-blur-sm z-10 flex items-center justify-between py-3 px-4 md:px-8 bg-white/80 shadow-lg">
